...
3. WHEN an inbound message is free text with no image THEN the System SHALL classify it into ENQUIRY, ENROLLMENT, or PAYMENT using the Router Agent (LLM), using the participant's last 6 chat turns as context.
